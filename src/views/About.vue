        ...
        <div v-if="hasContact">
          ...
          <div v-if="hasContactLinks" class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <a v-if="contactConfig?.telegram" :href="contactConfig.telegram" target="_blank" rel="noopener noreferrer"
              class="group flex items-center justify-center space-x-3 theme-surface-soft border-2 theme-border theme-text-secondary px-6 py-4 transition-colors hover:theme-text-primary hover-scale">
            ...
            <a v-if="contactConfig?.whatsapp" :href="contactConfig.whatsapp" target="_blank" rel="noopener noreferrer"
              class="group flex items-center justify-center space-x-3 theme-surface-soft border theme-border theme-text-secondary px-6 py-4 rounded-xl transition-colors hover:theme-text-primary hover-scale">
